...
namespace DesktopApplicationTemplate.UI.ViewModels
{
    ...
    /// </summary>
    public class FtpServerViewViewModel : ViewModelBase, ILoggingViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FtpServerViewViewModel"/> class.
        /// </summary>
        /// <param name="ftpServerService">Service hosting the FTP server.</param>
        /// <param name="logger">Optional logging service.</param>
        public FtpServerViewViewModel(IFtpServerService ftpServerService, ILoggingService? logger = null)
        {
